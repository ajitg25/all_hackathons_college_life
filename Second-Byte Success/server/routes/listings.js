...
router.post("/add", jwt({ secret: "secret", algorithms: ["HS256"] }), (req, res) => {
...
router.put('/update/:id', jwt({ secret: "secret", algorithms: ["HS256"] }), (req, res) => {
  if (!req.body.title || !req.body.description || !req.body.restrictions) {
...
router.delete('/delete', jwt({ secret: "secret", algorithms: ['HS256'] }), (req, res) => {
  if (!req.body._id) {
